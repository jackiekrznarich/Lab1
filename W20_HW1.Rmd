...
# The two quotation marks create a character in the vector, and the tricky variable is implicitly made into the character type (coercion)
```
...
semesters <- c('Winter2015', 'Spring2015', 'Summer2015', 'Fall2015', 'Winter2016', 'Spring2016', 'Summer2016', 'Fall2016', 'Winter2017', 'Spring2017', 'Summer2017', 'Fall2017', 'Winter2018', 'Spring2018', 'Summer2018', 'Fall2018', 'Winter2019', 'Spring2019', 'Summer2019', 'Fall2019', 'Winter2020')
# Build a vector of the supplements consumed (see powerpoint slides): 
supplements <- c('BRMPS', 'HiMaize260', 'inulin', 'arabinoxylan', 'psyllium', 'BRMPS + pysllium', 'BRMPS + accessible corn starch', 'accessible corn starch', 'resistant banana starch', 'transition on HiMaize260/switch to BRMPS', 'BRMPS + HiMaize20', 'LOODAAT potatp starch', 'oat', 'rice')
# What type are each of these? 
# Both are type character
```

# Question 4
```{r}
# Build a vector of the typical age of college students:
typical_age <- c(18, 19, 20, 21, 22)
# Confirm this is numeric
# class(typical_age) is "numeric"
# Convert this vector to character:
typical_age <- as.character(typical_age)
```
